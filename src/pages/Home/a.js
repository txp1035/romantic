export class Heart {
  ...
  init({ color = 'RGBA(252, 107, 113, 1.00)', mp3 }) {
    // 画布
  ...
  // 传入角度，生成爱心单个点位
  generatePoint(t, multiple = this.multiple) {
